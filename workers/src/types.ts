export interface Env {
  ...
  APP_USAGE_SESSION_MAX_MINUTES?: string;

  VOICE_DIARY_NOTES_DB_ID?: string;
  VOICE_DIARY_NAME_PROPERTY_NAME?: string;
  VOICE_DIARY_TARGET_DATE_PROPERTY_NAME?: string;
  VOICE_DIARY_RECORDED_AT_PROPERTY_NAME?: string;
  VOICE_DIARY_TEXT_PROPERTY_NAME?: string;
  VOICE_DIARY_SOURCE_PROPERTY_NAME?: string;
  VOICE_DIARY_NOTE_HASH_PROPERTY_NAME?: string;
  VOICE_DIARY_STATUS_PROPERTY_NAME?: string;
  ...
  DAILY_LOG_STUDY_MINUTES_PROPERTY_NAME?: string;
  DAILY_LOG_STUDY_SESSIONS_PROPERTY_NAME?: string;
  DAILY_LOG_STUDY_LAST_USED_AT_PROPERTY_NAME?: string;
